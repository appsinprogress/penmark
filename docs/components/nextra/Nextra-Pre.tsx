...
import { Button } from './Nextra-Button'
import { CopyToClipboard } from './Nextra-CopyToClipboard'
...
export const Pre = ({
  ...
  return (
    <div className="nextra-code-block nx-relative nx-mt-6 first:nx-mt-0">
      ...
      <pre
        className={cn(
          'nx-bg-primary-700/5 nx-overflow-x-auto nx-rounded-xl nx-font-medium nx-subpixel-antialiased dark:nx-bg-primary-300/10 nx-text-[.9em]',
