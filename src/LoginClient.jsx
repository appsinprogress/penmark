window.penmarkLoginInit = async function penmarkLoginInit(){
  //retrieve the head
  ...
  var loginLink = "https://penmark-oauth.appsinprogress.com/api/authorizeRequestHandler?redirect_uri=" + encodeURIComponent(window.location.href);
